...
public class KMeans {
    ...
    * to records in the dataset */
    ...
    public void clusteringOrders(List<OrderItem> orders, int countDrivers){
        DataSet orderSet = new DataSet(orders);
        kmeans(orderSet, countDrivers);
        orderSet.createCsvOutput("files/orderSetClustered.csv");
    }
